...
const slectedProductSlice = createSlice({
  name: "slectedproducts",
  initialState: [],
...
export const { addProduct, removeProduct, incrementProduct, decrementProduct , setProducts} =
  slectedProductSlice.actions;
export default slectedProductSlice.reducer;
