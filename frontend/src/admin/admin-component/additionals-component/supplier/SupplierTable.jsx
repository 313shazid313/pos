...
import { useGetAllSuppliersQuery } from "../../../../redux/additionals-state/supplierApi";
...
const SupplierTable = () => {
  ...
  const { data, isError, isLoading } = useGetAllSuppliersQuery();
            ...
            {data?.map((item) => (
              ...
              >
                ...
                <td className="px-3 py-3">
                  <Link to={`supplier-update/${item._id}`}>
